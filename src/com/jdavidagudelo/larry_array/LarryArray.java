package com.jdavidagudelo.larry_array;
...
public class LarryArray {
   ...
   number of inversions in the array */
    ...
    public String isSortable(int[] data){
        int inversions = mergeSort(data, data.length);
        if(inversions % 2 == 0){
            return "YES";
        }
        return "NO";
    ...
    public static void main(String[] args){
        LarryArray obj = new LarryArray();
        System.out.println(obj.isSortable(new int[]{3, 1, 2}));
        System.out.println(obj.isSortable(new int[]{1, 3, 4, 2}));
        System.out.println(obj.isSortable(new int[]{1, 2, 3, 5, 4}));
    }
}
